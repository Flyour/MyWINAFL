...
set_target_properties(dynamorio_static PROPERTIES
  INTERFACE_LINK_LIBRARIES "drhelper;libcmt;ntdll_imports"
)
...
set_target_properties(drinjectlib PROPERTIES
  INTERFACE_LINK_LIBRARIES "drdecode;drhelper;drdecode;libcmt.lib;ntdll_imports;kernel32;advapi32;imagehlp"
)
...
set_target_properties(drmemtrace_opcode_mix PROPERTIES
  INTERFACE_LINK_LIBRARIES "libcpmt;libcmt;dynamorio"
)
...
set_target_properties(drmemtrace_raw2trace PROPERTIES
  INTERFACE_LINK_LIBRARIES "libcpmt;libcmt;dynamorio;directory_iterator;drfrontendlib;drutil_static"
)
...
set_target_properties(drsyms PROPERTIES
  INTERFACE_LINK_LIBRARIES "libcpmt;libcmt;dynamorio;dbghelp;D:/derek/dr/build_package/build_release-64/ext/drsyms/dbghelp_imports.lib;drcontainers;D:/dynamorio_package/ext/drsyms/libelftc-pecoff/lib64/dwarf.lib;D:/dynamorio_package/ext/drsyms/libelftc-pecoff/lib64/elftc.lib"
)
...
set_target_properties(drsyms_static PROPERTIES
  INTERFACE_LINK_LIBRARIES "libcpmt;libcmt;dynamorio;dbghelp;D:/derek/dr/build_package/build_release-64/ext/drsyms/dbghelp_imports.lib;drcontainers;dwarf;elftc"
)
